...
<body>
	...
	<h3 align="left">Room CheckIn History</h3>
	...
	<form name="bookRoom" method="post">
		<table class="table">
			...
			<tr>
				...
				<!-- <td><label path="radioBtn"></label></td> -->
				<td><label path="roomNumber">Room No</label></td>
			...
			<c:forEach items="${entryDetailList}" var="item">
				<tr>
					<td><input type="radio" name="myradio"
						value="${item.roomNumber}" /></td>
					<!-- <td><label path="radioBtn"></label></td> -->
					<td><c:out value="${item.roomNumber}" /></td>
			...
			<tr>
				...
				<td>
					...
					<div class="form-group">
						<input type="submit" formaction="CheckoutRoom"
							value="Checkout Room" size="10" />
					</div> <!-- </form> -->
